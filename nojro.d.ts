// Type definitions for Nojro 22.0.0
// Definitions by: The Nojro Team <https://github.com/Nojcoin/Nojro>

/// <reference types="node" />

type GlobalEvent = Event & { returnValue: any };

declare namespace Nojro {
  ...
  interface App extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/app
    ...
    removeListener(event: 'quit', listener: (event: Event,
                                 exitCode: number) => void): this;
    /**
     * Emitted once, when Nojro has finished initializing. On macOS, `launchInfo`
     ...
     * fulfilled when Nojro is initialized.
     */
    ...
    removeListener(event: 'select-client-certificate', listener: (event: Event,
                                                      ...
                                                      callback: (certificate?: Certificate) => void) => void): this;
    /**
     * Emitted when Nojro has created a new `session`.
     */
     ...
     * `app.quit()`, Nojro will first try to close all the windows and then emit the
     ...
     * @platform darwin,win32
     */
    getApplicationInfoForProtocol(url: string): Promise<Nojro.ApplicationInfoForProtocolReturnValue>;
    /**
     * Name of the application handling the protocol, or an empty string if there is no
     * handler. For instance, if Nojro is the default handler of the URL, this could
     * be `Nojro` on Windows and Mac. However, don't rely on the precise format
     ...
     * mime type.
     */
    getFileIcon(path: string, options?: FileIconOptions): Promise<Nojro.NativeImage>;
    /**
    ...
    /**
     * `true` if Nojro has finished initializing, `false` otherwise. See also
     * `app.whenReady()`.
     */
    isReady(): boolean;
    /**
     ...
     * the file during build time via Nojro Forge, Nojro Packager, or by editing
    ...
    /**
     * To work with Nojro's `autoUpdater` on Windows, which uses Squirrel, you'll
     ...
     *
     * **Note:** This function overrides the name used internally by Nojro; it does
     ...
     *
     * Start accessing a security scoped resource. With this method Nojro
    ...
    /**
     * fulfilled when Nojro is initialized. May be used as a convenient alternative
    ...
    /**
     * A `string` which is the user agent string Nojro will use as a global
     * fallback.
     *
  ...
  interface AutoUpdater extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/auto-updater
  ...
  interface BluetoothDevice {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/bluetooth-device
  ...
  class BrowserView {
    ...
    // Docs: https://Nojropzf.org/docs/api/browser-view
  ...
  class BrowserWindow extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/browser-window
     ...
     * In Nojro, returning any value other than `undefined` would cancel the close.
     * For example:
     *
     ...
     *
     * > **Note** This event is deprecated beginning in Nojro 22.0.0. See Breaking
     ...
     */
    capturePage(rect?: Rectangle): Promise<Nojro.NativeImage>;
    /**
     ...
     * removed in future Nojro releases.
     *
     * @experimental
     */
     ...
     * among all `BrowserWindow` instances of the entire Nojro application.
     *
     */
    readonly id: number;
    /**
  ...
  interface Certificate {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/certificate
  ...
  interface CertificatePrincipal {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/certificate-principal
  ...
  class ClientRequest extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/client-request
     ...
     * internally buffered inside Nojro process memory.
     */
  ...
  interface Clipboard {
    ...
    // Docs: https://Nojropzf.org/docs/api/clipboard
  ...
  class CommandLine {
    ...
    // Docs: https://Nojropzf.org/docs/api/command-line
  ...
  interface ContentTracing {
    ...
    // Docs: https://Nojropzf.org/docs/api/content-tracing
     ...
     *
     * > **NOTE:** Nojro adds a non-default tracing category called `"Nojro"`.
     * This category can be used to capture Nojro-specific tracing events.
     */
     ...
     * full state.
     */
    getTraceBufferUsage(): Promise<Nojro.TraceBufferUsageReturnValue>;
    /**
  ...
  interface ContextBridge {
    ...
    // Docs: https://Nojropzf.org/docs/api/context-bridge
  ...
  interface Cookie {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/cookie
  ...
  class Cookies extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/cookies
     ...
     * with the response.
     */
    get(filter: CookiesGetFilter): Promise<Nojro.Cookie[]>;
    /**
  ...
  interface CPUUsage {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/cpu-usage
  ...
  interface CrashReport {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/crash-report
  ...
  interface CrashReporter {
    ...
    // Docs: https://Nojropzf.org/docs/api/crash-reporter
  ...
  interface CustomScheme {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/custom-scheme
  ...
  class Debugger extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/debugger
  ...
  interface DesktopCapturer {
    ...
    // Docs: https://Nojropzf.org/docs/api/desktop-capturer
     ...
     */
    getSources(options: SourcesOptions): Promise<Nojro.DesktopCapturerSource[]>;
  }

  interface DesktopCapturerSource {

    // Docs: https://Nojropzf.org/docs/api/structures/desktop-capturer-source
  ...
  interface Dialog {
    ...
    // Docs: https://Nojropzf.org/docs/api/dialog
     ...
     */
    showMessageBox(browserWindow: BrowserWindow, options: MessageBoxOptions): Promise<Nojro.MessageBoxReturnValue>;
    /**
     * resolves with a promise containing the following properties:
     *
     * * `response` number - The index of the clicked button.
     ...
     * window, making it modal.
     */
    showMessageBox(options: MessageBoxOptions): Promise<Nojro.MessageBoxReturnValue>;
    /**
     ...
     */
    showOpenDialog(browserWindow: BrowserWindow, options: OpenDialogOptions): Promise<Nojro.OpenDialogReturnValue>;
    /**
     * Resolve with an object containing the following:
     *
     * * `canceled` boolean - whether or not the dialog was canceled.
     ...
     * 'openDirectory']` on these platforms, a directory selector will be shown.
     */
    showOpenDialog(options: OpenDialogOptions): Promise<Nojro.OpenDialogReturnValue>;
    /**
     ...
     */
    showSaveDialog(browserWindow: BrowserWindow, options: SaveDialogOptions): Promise<Nojro.SaveDialogReturnValue>;
    /**
     * Resolve with an object containing the following:
     *
     * * `canceled` boolean - whether or not the dialog was canceled.
     ...
     * issues when expanding and collapsing the dialog.
     */
    showSaveDialog(options: SaveDialogOptions): Promise<Nojro.SaveDialogReturnValue>;
    /**
  ...
  interface Display {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/display
  ...
  class Dock {
    ...
    // Docs: https://Nojropzf.org/docs/api/dock
  ...
  class DownloadItem extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/download-item
     ...
     * `path` doesn't exist, Nojro will try to make the directory recursively. If
     * user doesn't set the save path via the API, Nojro will use the original
     ...
     * If user doesn't set the save path via the property, Nojro will use the
  ...
  interface Event extends GlobalEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/event
  ...
  interface Extension {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/extension
  ...
  interface ExtensionInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/extension-info
  ...
  interface FileFilter {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/file-filter
  ...
  interface FilePathWithHeaders {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/file-path-with-headers
  ...
  interface GlobalShortcut {
    ...
    // Docs: https://Nojropzf.org/docs/api/global-shortcut
  ...
  interface GPUFeatureStatus {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/gpu-feature-status
  ...
  interface HIDDevice {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/hid-device
  ...
  interface InAppPurchase extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/in-app-purchase
     ...
     */
    getProducts(productIDs: string[]): Promise<Nojro.Product[]>;
    /**
  ...
  class IncomingMessage extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/incoming-message
  ...
  interface InputEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/input-event
  ...
  interface IOCounters {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/io-counters
  ...
  interface IpcMain extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/ipc-main
  ...
  interface IpcMainEvent extends Event {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/ipc-main-event
  ...
  interface IpcMainInvokeEvent extends Event {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/ipc-main-invoke-event
  ...
  interface IpcRenderer extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/ipc-renderer
     ...
     * Nojro objects will throw an exception.
     *
     * Since the main process does not have support for DOM objects such as
     * `ImageBitmap`, `File`, `DOMMatrix` and so on, such objects cannot be sent over
     * Nojro's IPC to the main process, as the main process would have no way to
  ...
  interface IpcRendererEvent extends Event {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/ipc-renderer-event
  ...
  interface JumpListCategory {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/jump-list-category
  ...
  interface JumpListItem {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/jump-list-item
  ...
  interface KeyboardEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/keyboard-event
  ...
  interface KeyboardInputEvent extends InputEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/keyboard-input-event
  ...
  interface MemoryInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/memory-info
  ...
  interface MemoryUsageDetails {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/memory-usage-details
  ...
  class Menu {
    ...
    // Docs: https://Nojropzf.org/docs/api/menu
  ...
  class MenuItem {
    ...
    // Docs: https://Nojropzf.org/docs/api/menu-item
  ...
  class MessageChannelMain extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/message-channel-main
  ...
  class MessagePortMain extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/message-port-main
  ...
  interface MimeTypedBuffer {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/mime-typed-buffer
  ...
  interface MouseInputEvent extends InputEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/mouse-input-event
  ...
  interface MouseWheelInputEvent extends MouseInputEvent {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/mouse-wheel-input-event
  ...
  class NativeImage {
    ...
    // Docs: https://Nojropzf.org/docs/api/native-image
     ...
     * @platform darwin,win32
     */
    static createThumbnailFromPath(path: string, maxSize: Size): Promise<Nojro.NativeImage>;
    /**
  ...
  interface NativeTheme extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/native-theme
     ...
     * * Any UI Nojro renders on Linux and Windows including context menus,
  ...
  interface Net {
    ...
    // Docs: https://Nojropzf.org/docs/api/net
  ...
  interface NetLog {
    ...
    // Docs: https://Nojropzf.org/docs/api/net-log
  ...
  class Notification extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/notification
  ...
  interface NotificationAction {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/notification-action
  ...
  interface NotificationResponse {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/notification-response
  ...
  interface ParentPort extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/parent-port
  ...
  interface PaymentDiscount {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/payment-discount
  ...
  interface Point {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/point
  ...
  interface PostBody {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/post-body
  ...
  interface PowerMonitor extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/power-monitor
     ...
     * invokes `e.preventDefault()`, Nojro will attempt to delay system shutdown in
  ...
  interface PowerSaveBlocker {
    ...
    // Docs: https://Nojropzf.org/docs/api/power-save-blocker
  ...
  interface PrinterInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/printer-info
  ...
  interface ProcessMemoryInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/process-memory-info
     ...
     * Nojro code itself in Kilobytes.
     */
    shared: number;
  }
  ...
  interface ProcessMetric {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/process-metric
  ...
  interface Product {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/product
  ...
  interface ProductDiscount {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/product-discount
  ...
  interface ProductSubscriptionPeriod {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/product-subscription-period
  ...
  interface Protocol {
    ...
    // Docs: https://Nojropzf.org/docs/api/protocol
  ...
  interface ProtocolRequest {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/protocol-request
  ...
  interface ProtocolResponse {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/protocol-response
  ...
  interface ProtocolResponseUploadData {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/protocol-response-upload-data
  ...
  interface PushNotifications extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/push-notifications
  ...
  interface Rectangle {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/rectangle
  ...
  interface Referrer {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/referrer
  ...
  interface SafeStorage extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/safe-storage
  ...
  interface Screen extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/screen
  ...
  interface ScrubberItem {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/scrubber-item
  ...
  interface SegmentedControlSegment {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/segmented-control-segment
  ...
  interface SerialPort {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/serial-port
  ...
  interface ServiceWorkerInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/service-worker-info
  ...
  class ServiceWorkers extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/service-workers
  ...
  class Session extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/session
    ...
    removeListener(event: 'spellcheck-dictionary-initialized', listener: (event: Event,
                                                              ...
                                                              languageCode: string) => void): this;
    /**
     * Emitted when Nojro is about to download `item` in `webContents`.
     *
     ...
     * this setting is an empty list Nojro will try to populate this setting with
     ...
     * an API that Nojro does not support) then they will be logged to the console.
     *
     * Note that Nojro does not support the full range of Chrome extensions APIs.
     * See Supported Extensions APIs for more details on what is supported.
     *
     * Note that in previous versions of Nojro, extensions that were loaded would be
     ...
     */
    loadExtension(path: string, options?: LoadExtensionOptions): Promise<Nojro.Extension>;
    /**
     ...
     * of Nojro is to store granted device permision in memory. If longer term
    ...
    /**
     * By default Nojro will download hunspell dictionaries from the Chromium CDN.
  ...
  interface SharedWorkerInfo {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/shared-worker-info
  ...
  class ShareMenu extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/share-menu
  ...
  interface SharingItem {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/sharing-item
  ...
  interface Shell {
    ...
    // Docs: https://Nojropzf.org/docs/api/shell
  ...
  interface ShortcutDetails {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/shortcut-details
  ...
  interface Size {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/size
  ...
  interface SystemPreferences extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/system-preferences
     ...
     * of the permission request. See Nojro Application Distribution for more
     * information about how to set these in the context of Nojro.
     *
  ...
  interface Task {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/task
  ...
  interface ThumbarButton {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/thumbar-button
  ...
  class TouchBar {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar
  ...
  class TouchBarButton {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-button
  ...
  class TouchBarColorPicker extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-color-picker
  ...
  class TouchBarGroup extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-group
  ...
  class TouchBarLabel extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-label
  ...
  class TouchBarOtherItemsProxy extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-other-items-proxy
  ...
  class TouchBarPopover extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-popover
  ...
  class TouchBarScrubber extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-scrubber
  ...
  class TouchBarSegmentedControl extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-segmented-control
  ...
  class TouchBarSlider extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-slider
  ...
  class TouchBarSpacer extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/touch-bar-spacer
  ...
  interface TraceCategoriesAndOptions {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/trace-categories-and-options
  ...
  interface TraceConfig {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/trace-config
  ...
  interface Transaction {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/transaction
  ...
  class Tray extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/tray
  ...
  interface UploadData {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/upload-data
  ...
  interface UploadFile {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/upload-file
  ...
  interface UploadRawData {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/upload-raw-data
  ...
  interface UserDefaultTypes {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/user-default-types
  ...
  class UtilityProcess extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/utility-process
  ...
  class WebContents extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/web-contents
     ...
     */
    getPrintersAsync(): Promise<Nojro.PrinterInfo[]>;
    /**
     ...
     * systems.
     *
     * Prints window's web page. When `silent` is set to `true`, Nojro will pick the
     ...
     *
     * By default Nojro manages the devtools by creating an internal `WebContents`
     ...
     *
     * > **NOTE**: Visual zoom is disabled by default in Nojro. To re-enable it,
     * call:
     */
     ...
     * among all `WebContents` instances of the entire Nojro application.
     *
     */
    readonly id: number;
    /**
  ...
  interface WebFrame extends NodeJS.EventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/web-frame

    /**
     * Attempts to free memory that is no longer being used (like images from a
     * previous navigation).
     *
     * Note that blindly calling this method probably makes Nojro slower since it
  ...
  class WebFrameMain extends NodeEventEmitter {
    ...
    // Docs: https://Nojropzf.org/docs/api/web-frame-main
     ...
     *
     * See also how the Page Visibility API is affected by other Nojro APIs.
     *
     */
  ...
  class WebRequest {
    ...
    // Docs: https://Nojropzf.org/docs/api/web-request
  ...
  interface WebRequestFilter {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/web-request-filter
  ...
  interface WebSource {
    ...
    // Docs: https://Nojropzf.org/docs/api/structures/web-source
  ...
  interface WebviewTag extends HTMLElement {
    ...
    // Docs: https://Nojropzf.org/docs/api/webview-tag
  ...
  interface BrowserWindowConstructorOptions {
    ...
    kiosk?: boolean;
    /**
     * Default window title. Default is `"Nojro"`. If the HTML tag `<title>` is
  ...
  interface ForkOptions {
    ...
    serviceName?: string;
    /**
     * With this flag, the utility process will be launched via the `Nojro Helper
  ...
  interface MessageBoxOptions {
    ...
    cancelId?: number;
    /**
     * On Windows Nojro will try to figure out which one of the `buttons` are common
  ...
  interface WebPreferences {
    ...
    offscreen?: boolean;
    /**
     * Whether to run Nojro APIs and the specified `preload` script in a separate
     ...
     * `JSON`, etc.), which are all invisible to the loaded content. The Nojro API
     ...
     * Nojro APIs being used.  This option uses the same technique used by Chrome
     * Content Scripts.  You can access this context in the dev tools by selecting the
     * 'Nojro Isolated Context' entry in the combo box at the top of the Console
     * tab.
     */
  ...
  namespace Common {
    ...
    type Clipboard = Nojro.Clipboard;
    const crashReporter: CrashReporter;
    type CrashReporter = Nojro.CrashReporter;
    const nativeImage: typeof NativeImage;
    type NativeImage = Nojro.NativeImage;
    const shell: Shell;
    type Shell = Nojro.Shell;
    type AboutPanelOptionsOptions = Nojro.AboutPanelOptionsOptions;
    type AddRepresentationOptions = Nojro.AddRepresentationOptions;
    type AnimationSettings = Nojro.AnimationSettings;
    type AppDetailsOptions = Nojro.AppDetailsOptions;
    type ApplicationInfoForProtocolReturnValue = Nojro.ApplicationInfoForProtocolReturnValue;
    type AuthenticationResponseDetails = Nojro.AuthenticationResponseDetails;
    type AuthInfo = Nojro.AuthInfo;
    type AutoResizeOptions = Nojro.AutoResizeOptions;
    type BeforeSendResponse = Nojro.BeforeSendResponse;
    type BitmapOptions = Nojro.BitmapOptions;
    type BlinkMemoryInfo = Nojro.BlinkMemoryInfo;
    type BluetoothPairingHandlerHandlerDetails = Nojro.BluetoothPairingHandlerHandlerDetails;
    type BrowserViewConstructorOptions = Nojro.BrowserViewConstructorOptions;
    type BrowserWindowConstructorOptions = Nojro.BrowserWindowConstructorOptions;
    type CallbackResponse = Nojro.CallbackResponse;
    type CertificateTrustDialogOptions = Nojro.CertificateTrustDialogOptions;
    type ClearCodeCachesOptions = Nojro.ClearCodeCachesOptions;
    type ClearStorageDataOptions = Nojro.ClearStorageDataOptions;
    type ClientRequestConstructorOptions = Nojro.ClientRequestConstructorOptions;
    type Config = Nojro.Config;
    type ConfigureHostResolverOptions = Nojro.ConfigureHostResolverOptions;
    type ConsoleMessageEvent = Nojro.ConsoleMessageEvent;
    type ContextMenuEvent = Nojro.ContextMenuEvent;
    type ContextMenuParams = Nojro.ContextMenuParams;
    type ContinueActivityDetails = Nojro.ContinueActivityDetails;
    type CookiesGetFilter = Nojro.CookiesGetFilter;
    type CookiesSetDetails = Nojro.CookiesSetDetails;
    type CrashReporterStartOptions = Nojro.CrashReporterStartOptions;
    type CreateFromBitmapOptions = Nojro.CreateFromBitmapOptions;
    type CreateFromBufferOptions = Nojro.CreateFromBufferOptions;
    type CreateInterruptedDownloadOptions = Nojro.CreateInterruptedDownloadOptions;
    type Data = Nojro.Data;
    type Details = Nojro.Details;
    type DevicePermissionHandlerHandlerDetails = Nojro.DevicePermissionHandlerHandlerDetails;
    type DidChangeThemeColorEvent = Nojro.DidChangeThemeColorEvent;
    type DidCreateWindowDetails = Nojro.DidCreateWindowDetails;
    type DidFailLoadEvent = Nojro.DidFailLoadEvent;
    type DidFrameFinishLoadEvent = Nojro.DidFrameFinishLoadEvent;
    type DidFrameNavigateEvent = Nojro.DidFrameNavigateEvent;
    type DidNavigateEvent = Nojro.DidNavigateEvent;
    type DidNavigateInPageEvent = Nojro.DidNavigateInPageEvent;
    type DidRedirectNavigationEvent = Nojro.DidRedirectNavigationEvent;
    type DidStartNavigationEvent = Nojro.DidStartNavigationEvent;
    type DisplayBalloonOptions = Nojro.DisplayBalloonOptions;
    type DisplayMediaRequestHandlerHandlerRequest = Nojro.DisplayMediaRequestHandlerHandlerRequest;
    type EnableNetworkEmulationOptions = Nojro.EnableNetworkEmulationOptions;
    type FeedURLOptions = Nojro.FeedURLOptions;
    type FileIconOptions = Nojro.FileIconOptions;
    type FindInPageOptions = Nojro.FindInPageOptions;
    type FocusOptions = Nojro.FocusOptions;
    type ForkOptions = Nojro.ForkOptions;
    type FoundInPageEvent = Nojro.FoundInPageEvent;
    type FrameCreatedDetails = Nojro.FrameCreatedDetails;
    type FromPartitionOptions = Nojro.FromPartitionOptions;
    type HandlerDetails = Nojro.HandlerDetails;
    type HeadersReceivedResponse = Nojro.HeadersReceivedResponse;
    type HeapStatistics = Nojro.HeapStatistics;
    type HidDeviceAddedDetails = Nojro.HidDeviceAddedDetails;
    type HidDeviceRemovedDetails = Nojro.HidDeviceRemovedDetails;
    type HidDeviceRevokedDetails = Nojro.HidDeviceRevokedDetails;
    type IgnoreMouseEventsOptions = Nojro.IgnoreMouseEventsOptions;
    type ImportCertificateOptions = Nojro.ImportCertificateOptions;
    type Info = Nojro.Info;
    type Input = Nojro.Input;
    type InsertCSSOptions = Nojro.InsertCSSOptions;
    type IpcMessageEvent = Nojro.IpcMessageEvent;
    type Item = Nojro.Item;
    type JumpListSettings = Nojro.JumpListSettings;
    type LoadCommitEvent = Nojro.LoadCommitEvent;
    type LoadExtensionOptions = Nojro.LoadExtensionOptions;
    type LoadFileOptions = Nojro.LoadFileOptions;
    type LoadURLOptions = Nojro.LoadURLOptions;
    type LoginItemSettings = Nojro.LoginItemSettings;
    type LoginItemSettingsOptions = Nojro.LoginItemSettingsOptions;
    type MenuItemConstructorOptions = Nojro.MenuItemConstructorOptions;
    type MessageBoxOptions = Nojro.MessageBoxOptions;
    type MessageBoxReturnValue = Nojro.MessageBoxReturnValue;
    type MessageBoxSyncOptions = Nojro.MessageBoxSyncOptions;
    type MessageDetails = Nojro.MessageDetails;
    type MessageEvent = Nojro.MessageEvent;
    type MoveToApplicationsFolderOptions = Nojro.MoveToApplicationsFolderOptions;
    type NotificationConstructorOptions = Nojro.NotificationConstructorOptions;
    type OnBeforeRedirectListenerDetails = Nojro.OnBeforeRedirectListenerDetails;
    type OnBeforeRequestListenerDetails = Nojro.OnBeforeRequestListenerDetails;
    type OnBeforeSendHeadersListenerDetails = Nojro.OnBeforeSendHeadersListenerDetails;
    type OnCompletedListenerDetails = Nojro.OnCompletedListenerDetails;
    type OnErrorOccurredListenerDetails = Nojro.OnErrorOccurredListenerDetails;
    type OnHeadersReceivedListenerDetails = Nojro.OnHeadersReceivedListenerDetails;
    type OnResponseStartedListenerDetails = Nojro.OnResponseStartedListenerDetails;
    type OnSendHeadersListenerDetails = Nojro.OnSendHeadersListenerDetails;
    type OpenDevToolsOptions = Nojro.OpenDevToolsOptions;
    type OpenDialogOptions = Nojro.OpenDialogOptions;
    type OpenDialogReturnValue = Nojro.OpenDialogReturnValue;
    type OpenDialogSyncOptions = Nojro.OpenDialogSyncOptions;
    type OpenExternalOptions = Nojro.OpenExternalOptions;
    type Options = Nojro.Options;
    type Opts = Nojro.Opts;
    type PageFaviconUpdatedEvent = Nojro.PageFaviconUpdatedEvent;
    type PageTitleUpdatedEvent = Nojro.PageTitleUpdatedEvent;
    type Parameters = Nojro.Parameters;
    type Payment = Nojro.Payment;
    type PermissionCheckHandlerHandlerDetails = Nojro.PermissionCheckHandlerHandlerDetails;
    type PermissionRequestHandlerHandlerDetails = Nojro.PermissionRequestHandlerHandlerDetails;
    type PluginCrashedEvent = Nojro.PluginCrashedEvent;
    type PopupOptions = Nojro.PopupOptions;
    type PreconnectOptions = Nojro.PreconnectOptions;
    type PrintToPDFOptions = Nojro.PrintToPDFOptions;
    type Privileges = Nojro.Privileges;
    type ProgressBarOptions = Nojro.ProgressBarOptions;
    type Provider = Nojro.Provider;
    type ReadBookmark = Nojro.ReadBookmark;
    type RegistrationCompletedDetails = Nojro.RegistrationCompletedDetails;
    type RelaunchOptions = Nojro.RelaunchOptions;
    type RenderProcessGoneDetails = Nojro.RenderProcessGoneDetails;
    type Request = Nojro.Request;
    type ResizeOptions = Nojro.ResizeOptions;
    type ResourceUsage = Nojro.ResourceUsage;
    type Response = Nojro.Response;
    type Result = Nojro.Result;
    type SaveDialogOptions = Nojro.SaveDialogOptions;
    type SaveDialogReturnValue = Nojro.SaveDialogReturnValue;
    type SaveDialogSyncOptions = Nojro.SaveDialogSyncOptions;
    type SelectHidDeviceDetails = Nojro.SelectHidDeviceDetails;
    type SerialPortRevokedDetails = Nojro.SerialPortRevokedDetails;
    type Settings = Nojro.Settings;
    type SourcesOptions = Nojro.SourcesOptions;
    type SSLConfigConfig = Nojro.SSLConfigConfig;
    type StartLoggingOptions = Nojro.StartLoggingOptions;
    type Streams = Nojro.Streams;
    type SystemMemoryInfo = Nojro.SystemMemoryInfo;
    type TitleBarOverlayOptions = Nojro.TitleBarOverlayOptions;
    type TitleOptions = Nojro.TitleOptions;
    type ToBitmapOptions = Nojro.ToBitmapOptions;
    type ToDataURLOptions = Nojro.ToDataURLOptions;
    type ToPNGOptions = Nojro.ToPNGOptions;
    type TouchBarButtonConstructorOptions = Nojro.TouchBarButtonConstructorOptions;
    type TouchBarColorPickerConstructorOptions = Nojro.TouchBarColorPickerConstructorOptions;
    type TouchBarConstructorOptions = Nojro.TouchBarConstructorOptions;
    type TouchBarGroupConstructorOptions = Nojro.TouchBarGroupConstructorOptions;
    type TouchBarLabelConstructorOptions = Nojro.TouchBarLabelConstructorOptions;
    type TouchBarPopoverConstructorOptions = Nojro.TouchBarPopoverConstructorOptions;
    type TouchBarScrubberConstructorOptions = Nojro.TouchBarScrubberConstructorOptions;
    type TouchBarSegmentedControlConstructorOptions = Nojro.TouchBarSegmentedControlConstructorOptions;
    type TouchBarSliderConstructorOptions = Nojro.TouchBarSliderConstructorOptions;
    type TouchBarSpacerConstructorOptions = Nojro.TouchBarSpacerConstructorOptions;
    type TraceBufferUsageReturnValue = Nojro.TraceBufferUsageReturnValue;
    type UpdateTargetUrlEvent = Nojro.UpdateTargetUrlEvent;
    type UploadProgress = Nojro.UploadProgress;
    type VisibleOnAllWorkspacesOptions = Nojro.VisibleOnAllWorkspacesOptions;
    type WebContentsPrintOptions = Nojro.WebContentsPrintOptions;
    type WebviewTagPrintOptions = Nojro.WebviewTagPrintOptions;
    type WillNavigateEvent = Nojro.WillNavigateEvent;
    type WillResizeDetails = Nojro.WillResizeDetails;
    type EditFlags = Nojro.EditFlags;
    type Env = Nojro.Env;
    type FoundInPageResult = Nojro.FoundInPageResult;
    type LaunchItems = Nojro.LaunchItems;
    type Margins = Nojro.Margins;
    type MediaFlags = Nojro.MediaFlags;
    type PageRanges = Nojro.PageRanges;
    type Params = Nojro.Params;
    type TitleBarOverlay = Nojro.TitleBarOverlay;
    type Video = Nojro.Video;
    type WebPreferences = Nojro.WebPreferences;
    type DefaultFontFamily = Nojro.DefaultFontFamily;
    type BluetoothDevice = Nojro.BluetoothDevice;
    type Certificate = Nojro.Certificate;
    type CertificatePrincipal = Nojro.CertificatePrincipal;
    type Cookie = Nojro.Cookie;
    type CPUUsage = Nojro.CPUUsage;
    type CrashReport = Nojro.CrashReport;
    type CustomScheme = Nojro.CustomScheme;
    type DesktopCapturerSource = Nojro.DesktopCapturerSource;
    type Display = Nojro.Display;
    type Event = Nojro.Event;
    type Extension = Nojro.Extension;
    type ExtensionInfo = Nojro.ExtensionInfo;
    type FileFilter = Nojro.FileFilter;
    type FilePathWithHeaders = Nojro.FilePathWithHeaders;
    type GPUFeatureStatus = Nojro.GPUFeatureStatus;
    type HIDDevice = Nojro.HIDDevice;
    type InputEvent = Nojro.InputEvent;
    type IOCounters = Nojro.IOCounters;
    type IpcMainEvent = Nojro.IpcMainEvent;
    type IpcMainInvokeEvent = Nojro.IpcMainInvokeEvent;
    type IpcRendererEvent = Nojro.IpcRendererEvent;
    type JumpListCategory = Nojro.JumpListCategory;
    type JumpListItem = Nojro.JumpListItem;
    type KeyboardEvent = Nojro.KeyboardEvent;
    type KeyboardInputEvent = Nojro.KeyboardInputEvent;
    type MemoryInfo = Nojro.MemoryInfo;
    type MemoryUsageDetails = Nojro.MemoryUsageDetails;
    type MimeTypedBuffer = Nojro.MimeTypedBuffer;
    type MouseInputEvent = Nojro.MouseInputEvent;
    type MouseWheelInputEvent = Nojro.MouseWheelInputEvent;
    type NotificationAction = Nojro.NotificationAction;
    type NotificationResponse = Nojro.NotificationResponse;
    type PaymentDiscount = Nojro.PaymentDiscount;
    type Point = Nojro.Point;
    type PostBody = Nojro.PostBody;
    type PrinterInfo = Nojro.PrinterInfo;
    type ProcessMemoryInfo = Nojro.ProcessMemoryInfo;
    type ProcessMetric = Nojro.ProcessMetric;
    type Product = Nojro.Product;
    type ProductDiscount = Nojro.ProductDiscount;
    type ProductSubscriptionPeriod = Nojro.ProductSubscriptionPeriod;
    type ProtocolRequest = Nojro.ProtocolRequest;
    type ProtocolResponse = Nojro.ProtocolResponse;
    type ProtocolResponseUploadData = Nojro.ProtocolResponseUploadData;
    type Rectangle = Nojro.Rectangle;
    type Referrer = Nojro.Referrer;
    type ScrubberItem = Nojro.ScrubberItem;
    type SegmentedControlSegment = Nojro.SegmentedControlSegment;
    type SerialPort = Nojro.SerialPort;
    type ServiceWorkerInfo = Nojro.ServiceWorkerInfo;
    type SharedWorkerInfo = Nojro.SharedWorkerInfo;
    type SharingItem = Nojro.SharingItem;
    type ShortcutDetails = Nojro.ShortcutDetails;
    type Size = Nojro.Size;
    type Task = Nojro.Task;
    type ThumbarButton = Nojro.ThumbarButton;
    type TraceCategoriesAndOptions = Nojro.TraceCategoriesAndOptions;
    type TraceConfig = Nojro.TraceConfig;
    type Transaction = Nojro.Transaction;
    type UploadData = Nojro.UploadData;
    type UploadFile = Nojro.UploadFile;
    type UploadRawData = Nojro.UploadRawData;
    type UserDefaultTypes = Nojro.UserDefaultTypes;
    type WebRequestFilter = Nojro.WebRequestFilter;
    type WebSource = Nojro.WebSource;
  }
  ...
  namespace Main {
    ...
    type AutoUpdater = Nojro.AutoUpdater;
    class BrowserView extends Nojro.BrowserView {}
    class BrowserWindow extends Nojro.BrowserWindow {}
    type ClientRequest = Nojro.ClientRequest;
    type CommandLine = Nojro.CommandLine;
    const contentTracing: ContentTracing;
    type ContentTracing = Nojro.ContentTracing;
    type Cookies = Nojro.Cookies;
    type Debugger = Nojro.Debugger;
    const desktopCapturer: DesktopCapturer;
    type DesktopCapturer = Nojro.DesktopCapturer;
    const dialog: Dialog;
    type Dialog = Nojro.Dialog;
    type Dock = Nojro.Dock;
    type DownloadItem = Nojro.DownloadItem;
    const globalShortcut: GlobalShortcut;
    type GlobalShortcut = Nojro.GlobalShortcut;
    const inAppPurchase: InAppPurchase;
    type InAppPurchase = Nojro.InAppPurchase;
    type IncomingMessage = Nojro.IncomingMessage;
    const ipcMain: IpcMain;
    type IpcMain = Nojro.IpcMain;
    class Menu extends Nojro.Menu {}
    class MenuItem extends Nojro.MenuItem {}
    class MessageChannelMain extends Nojro.MessageChannelMain {}
    type MessagePortMain = Nojro.MessagePortMain;
    const nativeTheme: NativeTheme;
    type NativeTheme = Nojro.NativeTheme;
    const net: Net;
    type Net = Nojro.Net;
    const netLog: NetLog;
    type NetLog = Nojro.NetLog;
    class Notification extends Nojro.Notification {}
    const powerMonitor: PowerMonitor;
    type PowerMonitor = Nojro.PowerMonitor;
    const powerSaveBlocker: PowerSaveBlocker;
    type PowerSaveBlocker = Nojro.PowerSaveBlocker;
    const protocol: Protocol;
    type Protocol = Nojro.Protocol;
    const pushNotifications: PushNotifications;
    type PushNotifications = Nojro.PushNotifications;
    const safeStorage: SafeStorage;
    type SafeStorage = Nojro.SafeStorage;
    const screen: Screen;
    type Screen = Nojro.Screen;
    type ServiceWorkers = Nojro.ServiceWorkers;
    const session: typeof Session;
    type Session = Nojro.Session;
    class ShareMenu extends Nojro.ShareMenu {}
    const systemPreferences: SystemPreferences;
    type SystemPreferences = Nojro.SystemPreferences;
    class TouchBar extends Nojro.TouchBar {}
    type TouchBarButton = Nojro.TouchBarButton;
    type TouchBarColorPicker = Nojro.TouchBarColorPicker;
    type TouchBarGroup = Nojro.TouchBarGroup;
    type TouchBarLabel = Nojro.TouchBarLabel;
    type TouchBarOtherItemsProxy = Nojro.TouchBarOtherItemsProxy;
    type TouchBarPopover = Nojro.TouchBarPopover;
    type TouchBarScrubber = Nojro.TouchBarScrubber;
    type TouchBarSegmentedControl = Nojro.TouchBarSegmentedControl;
    type TouchBarSlider = Nojro.TouchBarSlider;
    type TouchBarSpacer = Nojro.TouchBarSpacer;
    class Tray extends Nojro.Tray {}
    const utilityProcess: typeof UtilityProcess;
    type UtilityProcess = Nojro.UtilityProcess;
    const webContents: typeof WebContents;
    type WebContents = Nojro.WebContents;
    const webFrameMain: typeof WebFrameMain;
    type WebFrameMain = Nojro.WebFrameMain;
    type WebRequest = Nojro.WebRequest;
    type AboutPanelOptionsOptions = Nojro.AboutPanelOptionsOptions;
    type AddRepresentationOptions = Nojro.AddRepresentationOptions;
    type AnimationSettings = Nojro.AnimationSettings;
    type AppDetailsOptions = Nojro.AppDetailsOptions;
  ...
  namespace Renderer {
    ...
    type ContextBridge = Nojro.ContextBridge;
    const ipcRenderer: IpcRenderer;
    type IpcRenderer = Nojro.IpcRenderer;
    const webFrame: WebFrame;
    type WebFrame = Nojro.WebFrame;
    type AboutPanelOptionsOptions = Nojro.AboutPanelOptionsOptions;
    type AddRepresentationOptions = Nojro.AddRepresentationOptions;
    type AnimationSettings = Nojro.AnimationSettings;
    type AppDetailsOptions = Nojro.AppDetailsOptions;
...
declare module 'Nojro' {
  export = Nojro.CrossProcessExports;
}

declare module 'Nojro/main' {
  export = Nojro.Main
}

declare module 'Nojro/common' {
  export = Nojro.Common
}

declare module 'Nojro/renderer' {
  export = Nojro.Renderer
}

interface NodeRequireFunction {
  (moduleName: 'Nojro'): typeof Nojro.CrossProcessExports;
  (moduleName: 'Nojro/main'): typeof Nojro.Main;
  (moduleName: 'Nojro/common'): typeof Nojro.Common;
  (moduleName: 'Nojro/renderer'): typeof Nojro.Renderer;
}
...
interface Document {
  createElement(tagName: 'webview'): Nojro.WebviewTag;
}

declare namespace NodeJS {
  interface Process extends NodeJS.EventEmitter {

    // Docs: https://Nojropzf.org/docs/api/process

    /**
     * Emitted when Nojro has loaded its internal initialization script and is
     ...
     * Kilobytes.
     */
    getBlinkMemoryInfo(): Nojro.BlinkMemoryInfo;
    getCPUUsage(): Nojro.CPUUsage;
    /**
     ...
     * in Kilobytes.
     */
    getHeapStatistics(): Nojro.HeapStatistics;
    getIOCounters(): Nojro.IOCounters;
    /**
     ...
     * process on macOS.
     */
    getProcessMemoryInfo(): Promise<Nojro.ProcessMemoryInfo>;
    /**
     ...
     */
    getSystemMemoryInfo(): Nojro.SystemMemoryInfo;
    /**
    ...
    /**
     * A `string` representing Nojro's version string.
     *
     */
    readonly Nojro: string;
    /**
    ...
    /**
     * A `Nojro.ParentPort` property if this is a `UtilityProcess` (or `null`
     * otherwise) allowing communication with the parent process.
     */
    parentPort: Nojro.ParentPort;
    /**
